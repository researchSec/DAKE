...
async function main() {
  ...
  exchangeContract[1] = await new ethers.Contract("0x62f578c9eb2aa944aD09cB0dc2ff97dA8366afF7",abi,addr[1]);
  ...
  const uPbeta = await eQ.computeSecret(pkP);
  const kstr = pkP + pk + uPbeta + idQ;
  //console.log(kstr);
