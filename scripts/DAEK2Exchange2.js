...
async function main() {
  ...
  exchangeContract[1] = await new ethers.Contract("0x55393f0A291C8711BC3A9C7E9DCDfC26dc094ADf",abi,addr[1]);
  ...
  hashforsig2.update(upi+pk+idPpi);
  ...
  const kstr = upi+pk+(await eQ.computeSecret(upi))+idQ;
